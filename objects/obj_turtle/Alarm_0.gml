...
//if !abs(dist_x) and !scr_grid_occupied(i, j + sign(dist_y))
//	dir_y = sign(dist_y)
	
//else if !abs(dist_y) and !scr_grid_occupied(i + sign(dist_x), j)
//	dir_x = sign(dist_x)
	
//else if (abs(dist_x) > abs(dist_y)) {
	
//	if !scr_grid_occupied(i, j + sign(dist_y))
//		dir_y = sign(dist_y)
		
//	else if !scr_grid_occupied(i + sign(dist_x), j)
//		dir_x = sign(dist_x)
//}
...
//	else if !scr_grid_occupied(i, j + sign(dist_y))
//		dir_y = sign(dist_y)
